...
public:	
    ...
    bool InstallIcon(LPCTSTR lpszToolTip, HICON hIcon, UINT nID)
    {
        ...
        _tcsncpy_s(m_nid.szTip, sizeof(m_nid.szTip), lpszToolTip, sizeof(m_nid.szTip));
        // Install
        m_bInstalled = (FALSE != Shell_NotifyIcon(NIM_ADD, &m_nid));
        // Done
        return m_bInstalled;
    }
    ...
    bool RemoveIcon()
    {
        ...
        // Remove
        m_nid.uFlags = 0;
        return (FALSE != Shell_NotifyIcon(NIM_DELETE, &m_nid));
    }
    ...
    bool SetTooltipText(LPCTSTR pszTooltipText)
    {
        ...
        _tcsncpy_s(m_nid.szTip, pszTooltipText, , sizeof(m_nid.szTip));
        // Set
        return (FALSE != Shell_NotifyIcon(NIM_MODIFY, &m_nid));
    }
